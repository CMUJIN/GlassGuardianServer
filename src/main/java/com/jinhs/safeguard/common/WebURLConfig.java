...
public class WebURLConfig {
	...
	public static String AUTH_CALLBACK_URL = "https://jinhsglassguard.appspot.com/auth/callback";
	//public static String AUTH_CALLBACK_URL = "http://localhost:8080/auth/callback";
	public static String AUTH_TOKEN_EXCHANGE_URL = "https://accounts.google.com/o/oauth2/token";
	public static String AUTH_TOKEN_EXHCNAGE_CALLBACK_URL = "https://jinhsglassguard.appspot.com/auth/exchange";
